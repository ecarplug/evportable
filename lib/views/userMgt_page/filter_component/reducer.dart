...
Reducer<FilterState> buildReducer() {
  return asReducer(
    <Object, Reducer<FilterState>>{
      ...
      FilterAction.selectName: _selectName,
...
FilterState _selectName(FilterState state, Action action) {
  final String userId = action.payload  ;
  final FilterState newState = state.clone();
  newState.user_id = userId;
  //newState.currentGenres = _user_nm ? state.movieGenres : state.tvGenres;
  return newState;
}
