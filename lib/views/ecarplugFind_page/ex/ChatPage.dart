...
/*
    ...
    //int length = int.parse(data[4]);

    print('length=' + data[4].toString());
    ...
    data.forEach((byte) {
      ...
      final littleEndian = Util.convertInt2Bytes(byte, Endian.little, 1);
      // print('original Value(int) : $data');
      print(
          'littleEndian : HEX: 0x${hex.encode(littleEndian)} DEC: $littleEndian');
    });
    */
    //print(data.toList());
...
/*
    ...
    //print('buffer.length=' + bufferIndex.toString());
