...
Widget buildView(
    EcarplugReportPageState state, Dispatch dispatch, ViewService viewService) {
                ...
                SliverPersistentHeader(
                  ...
                  delegate: SliverAppBarDelegate(
                      ...
                      child: _FilterBar(
                        ...
                        isBusy: state.isbusy,
                        onFilterPress: () => dispatch(
                            EcarplugReportPageActionCreator.filterTap()),
                        switchMedia: (isMovie) => dispatch(
                            EcarplugReportPageActionCreator.mediaTypeChange(
                                isMovie)),
                      )),
                ),
                SliverList(
