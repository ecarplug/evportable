      ...
      body: SafeArea(
        ...
        children: [
          ...
          _DataField(
            ...
            onChange: (s,e) => dispatch(FilterActionCreator.dateChange(s,e)),
          ),
...
class _MediaTypePanel extends StatelessWidget {
  ...
  const _MediaTypePanel({this.isCharger, this.onTap});
  @override
  Widget build(BuildContext context) {
    return Container(
      height: Adapt.px(150),
...
class _DataField extends StatelessWidget {
  ...
  const _DataField({this.onChange, this.startDate, this.endDate});
  @override
  Widget build(BuildContext context) {
    print(startDate);
    print(endDate);
          ...
          Expanded(
              ...
              child: Column(children: <Widget>[
                DateTimeField(
                    ...
                    onSaved: (DateTime _startDate) => onChange(_startDate,endDate),
                    onChanged: (DateTime _startDate) => {
                          onChange(_startDate,endDate)
          ...
          Expanded(
              ...
              child: Column(children: <Widget>[
                DateTimeField(
                    ...
                    onSaved: (DateTime _endDate) => onChange(startDate,_endDate),
                    onChanged: (DateTime _endDate) => {
