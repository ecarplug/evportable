...
class FilterActionCreator {
  ...
  static Action mediaTypeChange(bool isCharger) {
    return Action(FilterAction.mediaTypeChange, payload: isCharger);
  }
  ...
  static Action dateChange(DateTime s,DateTime e) {
    return Action(FilterAction.dateChange, payload: [s,e]);
  }
}
